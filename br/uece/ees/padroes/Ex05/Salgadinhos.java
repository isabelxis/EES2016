...
public class Salgadinhos extends MaquinaChain {

	private double preco = 2.0;

	public Salgadinhos() {
		super(Produto.Salgadinhos);
	}
	...
	protected void tentaEfetuarCompra() {
		...
		if (dinheiro < preco) {
			...
			System.out.println("Compra efetuada com sucesso! Pegue seu Salgadinho no valor de: " + preco);
